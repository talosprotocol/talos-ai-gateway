...
def upgrade() -> None:
    ...
    op.create_table('teams',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('org_id', sa.String(36), sa.ForeignKey('orgs.id'), nullable=False),
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
    )
    ...
    op.create_table('role_bindings',
        ...
        sa.Column('scope_org_id', sa.String(36), nullable=True),
        sa.Column('scope_team_id', sa.String(36), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
    )
    ...
    op.create_table('usage_events',
        ...
        sa.Column('key_id', sa.String(36), index=True),
        sa.Column('team_id', sa.String(36), index=True),
        sa.Column('org_id', sa.String(36), index=True),
